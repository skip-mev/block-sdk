...
protoImage=$(DOCKER) run --rm -v $(CURDIR):/workspace --user protobuild --workdir /workspace/proto $(protoImageName)
...
proto-format:
	@$(protoImage) touch test.txt && find ./ -name "*.proto" -exec clang-format -i {} \;
