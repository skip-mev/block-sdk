...
const (
	Msg_AuctionBid_FullMethodName   = "/skipmev.pob.builder.v1.Msg/AuctionBid"
	Msg_UpdateParams_FullMethodName = "/skipmev.pob.builder.v1.Msg/UpdateParams"
)
...
func (c *msgClient) AuctionBid(ctx context.Context, in *MsgAuctionBid, opts ...grpc.CallOption) (*MsgAuctionBidResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_AuctionBid_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_AuctionBid_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_AuctionBid_FullMethodName,
	}
