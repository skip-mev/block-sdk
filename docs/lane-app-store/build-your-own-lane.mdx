...
Before reading over this section, it is highly recommended that developers read over the [**How It Works**](/blocksdk/how-it-works) page.

If you have not already, this assumes you have completed the [General Setup]/block-sdk/integrate) guide first!
...
## 🤔 How to use it \[30 min\][](#-how-to-use-it-30-min "Direct link to heading")
...
### 1\. 🗄️ Mempool[](#1-️-mempool "Direct link to heading")
...
#### Using a Custom TxPriority[](#using-a-custom-txpriority "Direct link to heading")
...
### 2\. 🤝 MatchHandler[](#2--matchhandler "Direct link to heading")
...
#### Using a Custom MatchHandler[](#using-a-custom-matchhandler "Direct link to heading")
...
### \[OPTIONAL\] Steps 3-5[](#optional-steps-3-5 "Direct link to heading")
...
### 3\. 🛠️ PrepareLaneHandler[](#3-️-preparelanehandler "Direct link to heading")
...
### 4\. ✅ CheckOrderHandler[](#4--checkorderhandler "Direct link to heading")
...
### 5\. 🆗 ProcessLaneHandler[](#5--processlanehandler "Direct link to heading")
...
### 6\. 📝 Lane Configuration[](#6--lane-configuration "Direct link to heading")
...
#### **AnteHandler**[](#antehandler "Direct link to heading")
...
#### **MaxTxs**[](#maxtxs "Direct link to heading")
...
#### **MaxBlockSpace**[](#maxblockspace "Direct link to heading")
...
#### **\[OPTIONAL\] IgnoreList**[](#optional-ignorelist "Direct link to heading")
